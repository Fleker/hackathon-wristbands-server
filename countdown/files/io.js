...
//                       });
   ...
   */
  window.countdownTo = new Date().getTime() + 20000;
...
/**
* Sets the countdown to a new timestamp, explodes when it reaches 0
*/
function setCountdown(newdate) {
    countdownTo = newdate;
}
/**
* Sets countdown to x milliseconds in the future
*/ 
function incrementCountdown(x) {
    countdownTo = new Date().getTime()+x;   
}
/**
* Called when the countdown ends
*/
function doFinale() {
    document.getElementById('countdown').classList.add('end');
    document.getElementById('party').classList.add('end');
    setTimeout(function() {
        document.getElementById('party').src = '';
        
    document.getElementById('video').classList.add('begin');
    document.getElementById('video').src = 'https://drive.google.com/a/students.rowan.edu/file/d/0B68KZVjfbqhjQTZydy1SNTdMMTg/preview?start=1&autoplay=1&autoPlay=1'
    document.getElementById('slides').classList.add('begin');
        
        setTimeout(function() {
           console.log("Shift to slides"); 
            shiftToSlides();
        }, 1000*60+1000*35);
    }, 3000);
}
function shiftToSlides() {
    document.getElementById('slides').classList.add('begin');
            document.getElementById('video').classList.add('end');   
